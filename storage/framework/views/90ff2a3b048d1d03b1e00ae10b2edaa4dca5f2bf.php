...
<div class="container">
    ...
    <div class="left-side">
        ...
        <div class="button-align">
            <a href="/officers"><button class="button-content">Create Account</button></a>
        </div>
    ...
    <div class="right-side">
        ...
        <div class="content">
            ...
            <form action="#">
                <h1>Username (Enter Your Service Number)</h1>
...
<?php /**PATH D:\Mini Project\Group 07\07 - BackEnd\CoviGuard\resources\views/officerLogin.blade.php ENDPATH**/ ?>