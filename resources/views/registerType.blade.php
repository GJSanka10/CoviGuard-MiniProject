...
<head>
    ...
    <link rel="stylesheet" href="CSS\registerType.css">
...
<div class="background">
    ...
    <navbar>
        ...
        <ul>
            ...
            <li><button class="login-button"><a href="/loginType">LOGIN</a></button></li>
        </ul>
    </navbar>
    ...
    <div class="citizen">
        ...
        <div class="bbt">
            <a href="/citizens"><button class="button">Register</button></a>
        </div>
    </div>
    ...
    <div class="officer">
        ...
        <p>Browse and get vaccination and <br> quarantine services.</p>
        <div class="bbt">
            <a href="/loginType"><button class="button">Register</button></a>
        </div>
    </div>
